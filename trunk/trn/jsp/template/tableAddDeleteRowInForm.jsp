...
// 		Arunya.k		
	...
	<table id="model_<s:property value='#divresult[0]'/>" style="display: none;" >
		...
		<tr class="th">
			...
			<th class="checkbox ui-state-default"><input type="checkbox"  name="checkAll"  onClick="checkboxToggle( jQuery('div#<s:property value="#divresult[0]"/>  #cnkColumnId'),this.checked)" /></th>		
			<th class="edit ui-state-default"><s:text name="tutor.edit" /></th>	
			...
			<s:else>
				...
				<td class="edit">
					<a href="javascript:void(0);" onclick="prepareDataBeforeSetInForm(<s:property value='%{#status.index}'/>,'<s:property value='#divresult[0]'/>',<s:property value='#callbackFunction[0]'/>,'<s:property value='#listTableData'/>',arrayHid_<s:property value='#divresult[0]'/>);">
				 		<img src="<s:url value='/images/icon/i_edit.png'/>" />
				 	</a>
				</td>
	...
	<table class="RESULT_FOOTER" id="footerTable_<s:property value='#divresult[0]'/>" style="display: none">
		<tr>
			<td class="LEFT">
				<a href="javascript:void(0);" id="btnDel" onclick="deleteRowInForm_by_elname('<s:property value="#divresult[0]"/>','tableId_<s:property value='#divresult[0]'/>');clearCurrentRowEdited();"><img src="<s:url value='/images/icon/i_del.png' />">&nbsp;<s:text name="deleteSelect" /></a>&nbsp;&nbsp;
				<input type="text" id="currentRowEdited_<s:property value='#divresult[0]'/>">
			</td>
			<td class="RIGHT"></td>
		</tr>
	</table>
