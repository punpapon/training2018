 ...
 * 
 * Change log : change name function :- tooltip -> tooltipeasy, menu ->
 * menueasy, menubutton -> menueasybutton, tabs -> tabs2, dialog -> dialogeasy
 */
(function($) {
	$.parser = {
		auto : true,
		...
		plugins : [ "draggable", "droppable", "resizable", "pagination",
				"tooltipeasy", "linkbutton", "menueasy", "menueasybutton",
				"splitbutton", "progressbar", "tree", "combobox", "combotree",
				...
				"propertygrid", "treegrid", "tabs2", "accordion", "window",
				"dialogeasy" ],
		parse : function(_2) {
			var aa = [];
...
(function($) {
	...
	;
	$.fn.tooltipeasy = function(_1c9, _1ca) {
		if (typeof _1c9 == "string") {
			return $.fn.tooltipeasy.methods[_1c9](this, _1ca);
		}
		_1c9 = _1c9 || {};
		return this.each(function() {
			...
			if (_1cb) {
				...
				$.data(this, "tooltip", {
					options : $.extend({}, $.fn.tooltipeasy.defaults,
							$.fn.tooltipeasy.parseOptions(this), _1c9)
				});
				init(this);
			}
			_1b2(this);
	...
	$.fn.tooltipeasy.methods = {
		...
		arrow : function(jq) {
			return jq.tooltipeasy("tip").children(
	...
	$.fn.tooltipeasy.parseOptions = function(_1cd) {
		var t = $(_1cd);
...
(function($) {
	...
	function _1e5(_1e8) {
		...
		t.find(".m-btn").each(function() {
			$(this).menueasybutton("destroy");
		});
		t.find(".s-btn").each(function() {
			$(this).splitbutton("destroy");
		});
		t.find(".tooltip-f").tooltipeasy("destroy");
	}
	;
	function _1e9(_1ea) {
		$(_1ea)
...
(function($) {
	...
	;
	$.fn.dialogeasy = function(_256, _257) {
		if (typeof _256 == "string") {
			var _258 = $.fn.dialogeasy.methods[_256];
			if (_258) {
		...
		return this.each(function() {
			...
			if (_259) {
				...
				$.data(this, "dialog", {
					options : $.extend({}, $.fn.dialogeasy.defaults,
							$.fn.dialogeasy.parseOptions(this), _256),
	...
	$.fn.dialogeasy.parseOptions = function(_25d) {
		return $.extend({}, $.fn.window.parseOptions(_25d), $.parser
				.parseOptions(_25d, [ "toolbar", "buttons" ]));
	};
	$.fn.dialogeasy.defaults = $.extend({}, $.fn.window.defaults, {
		title : "New Dialog",
		collapsible : false,
		minimizable : false,
		maximizable : false,
...
(function($) {
	...
	function _2cf(_2d0) {
		...
		for (var i = 0; i < _2d1.tabs2.length; i++) {
			var _2d4 = _2d1.tabs2[i].panel("options");
	...
	function _2e0(_2e1) {
		...
		$(_2e1).children("div.tabs-header").unbind().bind("click", function(e) {
			if ($(e.target).hasClass("tabs-scroller-left")) {
				$(_2e1).tabs2("scrollBy", -opts.scrollIncrement);
			} else {
	...
	function _2ef(_309, _30a) {
		...
		if (left < 0 || _30f > wrap.width()) {
			...
			$(_309).tabs2("scrollBy", _310);
		} else {
			$(_309).tabs2("scrollBy", 0);
		}
		_2d7(_309);
	...
	;
	$.fn.tabs2 = function(_313, _314) {
		if (typeof _313 == "string") {
			return $.fn.tabs2.methods[_313](this, _314);
		}
		_313 = _313 || {};
		return this.each(function() {
			...
			if (_315) {
				...
				$.data(this, "tabs", {
					options : $.extend({}, $.fn.tabs2.defaults, $.fn.tabs2
	...
	$.fn.tabs2.methods = {
		...
		enableTab : function(jq, _31c) {
			return jq.each(function() {
				$(this).tabs2("getTab", _31c).panel("options").tab
						.removeClass("tabs-disabled");
			});
		},
		disableTab : function(jq, _31d) {
			return jq.each(function() {
				$(this).tabs2("getTab", _31d).panel("options").tab
						.addClass("tabs-disabled");
			});
		},
		scrollBy : function(jq, _31e) {
			return jq.each(function() {
				var opts = $(this).tabs2("options");
	...
	$.fn.tabs2.parseOptions = function(_320) {
...
(function($) {
	function init(_376) {
		...
		$(document).unbind(".menu").bind("mousedown.menu", function(e) {
			...
			$("body>div.menu-top:visible").menueasy("hide");
		});
		var _378 = _379($(_376));
	...
	function _380(_388, item) {
		...
		item.bind("click.menu", function() {
			...
			var item = $(_388).menueasy("getItem", this);
	...
	function _38e(_38f, _390) {
		...
		menu.show(0, function() {
			...
			menu[0].shadow.css({
				display : "block",
				zIndex : $.fn.menueasy.defaults.zIndex++,
				left : menu.css("left"),
				top : menu.css("top"),
				width : menu.outerWidth(),
				height : menu.outerHeight()
			});
			menu.css("z-index", $.fn.menueasy.defaults.zIndex++);
			if (menu.hasClass("menu-top")) {
	...
	function _393(_394, text) {
		...
		function find(menu) {
			menu.children("div.menu-item").each(function() {
				var item = $(_394).menueasy("getItem", this);
	...
	;
	$.fn.menueasy = function(_3a4, _3a5) {
		if (typeof _3a4 == "string") {
			return $.fn.menueasy.methods[_3a4](this, _3a5);
		}
		_3a4 = _3a4 || {};
		return this.each(function() {
			...
			if (_3a6) {
				...
				_3a6 = $.data(this, "menu", {
					options : $.extend({}, $.fn.menueasy.defaults,
							$.fn.menueasy.parseOptions(this), _3a4)
				});
				init(this);
			}
			$(this).css({
	...
	$.fn.menueasy.methods = {
		...
		setIcon : function(jq, _3a8) {
			return jq.each(function() {
				var item = $(this).menueasy("getItem", _3a8.target);
				if (item.iconCls) {
	...
	$.fn.menueasy.parseOptions = function(_3ae) {
		return $.extend({}, $.parser.parseOptions(_3ae, [ "left", "top", {
			minWidth : "number"
		} ]));
	};
	$.fn.menueasy.defaults = {
		zIndex : 110000,
		left : 0,
		top : 0,
		minWidth : 120,
...
(function($) {
	function init(_3af) {
		...
		if (opts.menueasy) {
			$(opts.menueasy).menueasy();
			var _3b0 = $(opts.menueasy).menueasy("options");
			var _3b1 = _3b0.onShow;
			var _3b2 = _3b0.onHide;
			$.extend(_3b0, {
				onShow : function() {
					var _3b3 = $(this).menueasy("options");
					var btn = $(_3b3.alignTo);
					var opts = btn.menueasybutton("options");
					btn.addClass((opts.plain == true) ? opts.cls.btn2
							: opts.cls.btn1);
					_3b1.call(this);
				},
				onHide : function() {
					var _3b4 = $(this).menueasy("options");
	...
	function _3b9(_3ba) {
		...
		if (opts.disabled || !opts.menueasy) {
			return;
		}
		$("body>div.menu-top").menueasy("hide");
		var btn = $(_3ba);
		var mm = $(opts.menueasy);
		if (mm.length) {
			mm.menueasy("options").alignTo = btn;
			mm.menueasy("show", {
				alignTo : btn
			});
		}
	...
	;
	$.fn.menueasybutton = function(_3bb, _3bc) {
		if (typeof _3bb == "string") {
			var _3bd = $.fn.menueasybutton.methods[_3bb];
			if (_3bd) {
		...
		return this.each(function() {
			...
			if (_3be) {
				...
				$.data(this, "menubutton", {
					options : $.extend({}, $.fn.menueasybutton.defaults,
							$.fn.menueasybutton.parseOptions(this), _3bb)
				});
				$(this).removeAttr("disabled");
			}
			init(this);
	...
	$.fn.menueasybutton.methods = {
		...
		destroy : function(jq) {
			return jq.each(function() {
				var opts = $(this).menueasybutton("options");
				if (opts.menueasy) {
					$(opts.menueasy).menueasy("destroy");
				}
				$(this).remove();
			});
		}
	};
	$.fn.menueasybutton.parseOptions = function(_3c1) {
		var t = $(_3c1);
	...
	$.fn.menueasybutton.defaults = $.extend({}, $.fn.linkbutton.defaults, {
		plain : true,
		menu : null,
		duration : 100,
		cls : {
...
(function($) {
	...
	$.fn.splitbutton = function(_3c3, _3c4) {
		if (typeof _3c3 == "string") {
			...
			if (_3c5) {
				...
				return this.menueasybutton(_3c3, _3c4);
			}
		}
		_3c3 = _3c3 || {};
		return this.each(function() {
	...
	$.fn.splitbutton.methods = {
		options : function(jq) {
			var _3c7 = jq.menueasybutton("options");
...
(function($) {
	...
	function _3d2(_3d3) {
		...
		if (opts.menueasy) {
			_3d4.menueasy = $(opts.menueasy).menueasy({
				onClick : function(item) {
					_3d5(item);
				}
			});
			var item = _3d4.menueasy.children("div.menu-item:first");
			_3d4.menueasy.children("div.menu-item").each(function() {
		...
		function _3d5(item) {
			...
			var mb = $(
					...
					.html(item.text);
			mb.prependTo(_3d4.searchbox).menueasybutton({
				menu : _3d4.menueasy,
				iconCls : item.iconCls
			});
	...
	$.fn.searchbox.methods = {
		...
		menu : function(jq) {
			return $.data(jq[0], "searchbox").menueasy;
		},
		textbox : function(jq) {
		...
		selectName : function(jq, name) {
			return jq.each(function() {
				var menu = $.data(this, "searchbox").menueasy;
				if (menu) {
...
(function($) {
	...
	function _3ef(_3f0) {
		...
		$(_3f0).tooltipeasy($.extend({}, opts.tipOptions, {
...
(function($) {
	...
	function _7d9(_7da) {
		...
		if ($.fn.window) {
			// if (document.getElementById(elenameglo).value.length >= 13) {
			_7dc.panel("panel").css("z-index",
					$.fn.window.defaults.zIndex++ + 1000);
			// } else {
			// _7dc.panel("panel").css("z-index",-1);
			// }

			// alert(elenameglo);
			// if (typeof elenameglo != 'undefined' && elenameglo == -1) {
			// _7dc.panel("panel").css("z-index",-1);
			// } else {
